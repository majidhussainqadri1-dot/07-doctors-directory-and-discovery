...
php='\n'.join((R/p).read_text(encoding='utf-8') for p in ['doctors-directory/includes/class-ddd-future-query.php','doctors-directory/includes/class-ddd-future-discovery.php','doctors-directory/includes/class-ddd-future-preferences.php','doctors-directory/includes/class-ddd-future-ui.php'])
...
('FUT-08 saved-search alerts', 'ddd_saved_searches_v1' in php and 'DoctorSavedSearchMatched.v1' in php and 'sabri_file19_notification_event_v1' in php),
('FUT-09 private shortlists', 'ddd_shortlists_v1' in php and 'MAX_SHORTLIST_ITEMS' in php),
...
('FUT-24 offline low-bandwidth pack', '/future/offline-pack' in php and 'stale_label_required' in php and 'stale-if-error' in php),
]
failed=[]
